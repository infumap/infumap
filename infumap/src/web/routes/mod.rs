...
pub fn default_dock_page(owner_id: &str, dock_page_id: Uid, natural_aspect: f64) -> Item {
  ...
  Item {
    ...
    spatial_width_gr: Some(inner_spatial_width_br * GRID_SIZE),
    ...
    default_popup_position_gr: Some(Vector { x: inner_spatial_width_br / 2 * GRID_SIZE, y: ((inner_spatial_height_br as f64 * 0.4) as i64) * GRID_SIZE }),
    default_popup_width_gr: Some(inner_spatial_width_br / 2 * GRID_SIZE),
