...
const ITEM_TYPES = [ItemType.Page, ItemType.Note, ItemType.Table, ItemType.Image, ItemType.File, ItemType.Text, ItemType.Password, ItemType.Search, ItemType.Composite];
