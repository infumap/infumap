...
const ITEM_TYPES = [ItemType.Page, ItemType.Note, ItemType.Table, ItemType.Image, ItemType.File, ItemType.Link, ItemType.Password, ItemType.Composite, ItemType.Expression];
