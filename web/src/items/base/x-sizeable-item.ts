...
const ITEM_TYPES = [ItemType.Page, ItemType.Note, ItemType.Table, ItemType.Image, ItemType.File, ItemType.Text, ItemType.Password, ItemType.Search, ItemType.Divider, ItemType.Composite];
const HALF_SIZEABLE_ITEM_TYPES = [ItemType.Note, ItemType.Table, ItemType.Image, ItemType.File, ItemType.Text, ItemType.Password, ItemType.Composite];
