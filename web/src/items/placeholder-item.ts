...
export function calcGeometryOfPlaceholderItem_Desktop(_placeholder: PlaceholderMeasurable, _containerBoundsPx: BoundingBox, _containerInnerSizeBl: Dimensions, _emitHitboxes: boolean, _renderChildrenAsFull: boolean): ItemGeometry {
  panic();
}
