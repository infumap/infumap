...
import { DialogMoveState, dialogMoveState } from "./mouse_dialogState";
...
export let lastMouseOverVes: VisualElementSignal | null = null;
export let lastMouseOverOpenPopupVes: VisualElementSignal | null = null;
