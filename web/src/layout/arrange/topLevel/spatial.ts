...
//       visualElementSpec.popupVes = arrangeCellPopup(store, null);
//     } else {
...
//   return arrangeItem(store, parentPath, null, ArrangeAlgorithm.SpatialStretch, item, itemGeometry, renderChildrenAsFull, isPopup, isRoot, false, false);
// }
