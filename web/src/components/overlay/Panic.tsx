...
import { Z_INDEX_GLOBAL_PANIC } from "../../constants";
...
export const Panic: Component = () => {
  ...
  return (
    <div id="panicOverlay"
         ...
         style={`background-color: #ff000010; z-index: ${Z_INDEX_GLOBAL_PANIC};`}
      ...
      <div class="fixed select-text"
        ...
        <div style={`font-size: 20px; z-index: ${Z_INDEX_GLOBAL_PANIC+1}`}><i>{getPanickedMessage()}</i></div>
      </div>
    </div>
  );
}
