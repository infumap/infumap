    ...
    <Show when={props.visualElement.childAreaBoundsPx != null}>
      <div
        ...
        style={`left: ${viewportBoundsPx().x}px; ` +
          ...
          `overflow-y: ${props.visualElement.boundsPx.h < props.visualElement.childAreaBoundsPx!.h ? "auto" : "visible"}; ` +
          `overflow-x: ${props.visualElement.boundsPx.w < props.visualElement.childAreaBoundsPx!.w ? "auto" : "visible"}; ` +
