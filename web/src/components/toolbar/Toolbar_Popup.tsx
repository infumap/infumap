...
export const Toolbar_Popup: Component = () => {
  ...
  const [sliderValue, setSliderValue] = createSignal(asTableItem(store.history.getFocusItem()).numberOfVisibleColumns.toString());
  ...
  const handleTextChange = () => {
    if (overlayTypeConst == ToolbarPopupType.PageWidth) {
      ...
      let newNumCols = parseInt(textElement!.value, 10);
              ...
              {overlayType() == ToolbarPopupType.TableNumCols ?
                <div class="flex items-center mt-[7px]">
                  ...
                  <input ref={textElement}
                         ...
                         onInput={(e) => setSliderValue(e.currentTarget.value)}
